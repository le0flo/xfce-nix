...
stdenv.mkDerivation (finalAttrs: {
  ...
  # libxfce4ui headers include libxfce4util headers, but some panel targets
  # do not add that include path themselves.
  ...
  postPatch = ''
    ...
    # libxfce4ui 4.21 already defines XfceTitledDialog autoptr cleanup.
    sed -i '27,29d' panel/panel-tic-tac-toe.h
