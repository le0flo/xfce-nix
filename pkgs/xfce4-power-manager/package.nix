...
stdenv.mkDerivation (finalAttrs: {
  ...
  postPatch = ''
    ...
    # Upstream forgot to attach GTK to the main daemon target.
    sed -i '/$(LIBNOTIFY_CFLAGS)/i\	$(GTK_CFLAGS) \\' src/Makefile.am
    sed -i '/$(GTHREAD_LIBS)/a\	$(GTK_LIBS) \\' src/Makefile.am
  '';
